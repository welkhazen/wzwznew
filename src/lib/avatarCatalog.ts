...
export const DEFAULT_AVATAR_CATALOG: readonly AvatarCatalogItem[] = [
  ...
  { id: "horned-iron", level: 13, name: "Viozen", price: "50", imageSrc: "/avatars/5.webp", bg: "#1f0a05", figure: "#fb923c", ring: "#fb923c", glow: "#fb923c80", isActive: true, showIn: "both", rarity: "common" },
