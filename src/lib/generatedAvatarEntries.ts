...
export const GENERATED_AVATAR_ENTRIES: readonly AvatarCatalogItem[] = [
  ...
  { id: "avatar-40", level: 40, name: "Avatar 40", price: "50", imageSrc: "/avatars/40.png", bg: "#1e1614", figure: "#f8b8a8", ring: "#f8b8a8", glow: "#f8b8a880", isActive: true, showIn: "both", rarity: "common" },
  { id: "avatar-41", level: 41, name: "Avatar 41", price: "50", imageSrc: "/avatars/41.png", bg: "#160e1e", figure: "#b878f8", ring: "#b878f8", glow: "#b878f880", isActive: true, showIn: "both", rarity: "common" },
