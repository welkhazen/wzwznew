...
const PACKAGES = [
  { id: "starter", tokens: 100, price: 0.99, label: "Starter", highlight: false, accent: "from-sky-500/20 via-blue-500/10 to-transparent", perToken: "$0.0099 / token" },
  { id: "boost", tokens: 500, price: 3.99, label: "Popular", highlight: false, accent: "from-raw-gold/25 via-amber-500/10 to-transparent", perToken: "$0.008 / token" },
  { id: "stash", tokens: 1500, price: 9.99, label: "Best Value", highlight: true, accent: "from-emerald-500/20 via-teal-500/10 to-transparent", perToken: "$0.0067 / token" },
] as const;
