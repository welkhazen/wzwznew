      ...
      <div className="relative z-10 mx-auto max-w-5xl space-y-9 px-4 py-10 pt-20 text-center sm:space-y-12 sm:px-6 sm:py-12 sm:pt-14">
        ...
        >
          ...
          >
            ...
            <span className="relative z-10 w-full text-center text-[0.69rem] font-bold uppercase tracking-[0.2em] text-primary sm:text-sm sm:tracking-wider">Anonymous First • Community Driven • Identity Based</span>
            <div
