        ...
        <div className="relative flex items-center justify-center">
          ...
          {!isLastPoll && (
            <button
              ...
              className="absolute right-0 z-10 flex h-11 w-11 translate-x-3 items-center justify-center rounded-full border border-raw-gold/55 bg-black/75 text-raw-gold transition hover:bg-raw-gold/10 disabled:cursor-not-allowed disabled:opacity-25 sm:translate-x-7"
            >
