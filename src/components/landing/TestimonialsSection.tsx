    ...
    <section className="landing-section relative px-4 py-14 sm:px-6 sm:py-20">
      <div className="relative w-full overflow-hidden rounded-2xl border border-raw-border/40 bg-raw-surface/20 px-6 py-10 sm:px-10 sm:py-14">
        <div className="mb-10 flex flex-col items-center gap-3 sm:mb-12">
          <p className="text-center font-display text-[10px] uppercase tracking-[0.3em]">
          ...
          <Button
            ...
            size="sm"
            disabled
            className="rounded-full border-raw-border/70 bg-raw-surface/60 text-raw-text shadow-[0_0_0_1px_rgba(255,255,255,0.06)_inset]"
          >
            Coming Soon
          </Button>
        </div>
