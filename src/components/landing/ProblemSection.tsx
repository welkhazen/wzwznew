  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-6xl">
        ...
        >
          <div className="relative mb-7 h-32 w-full overflow-hidden rounded-[1.5rem] border border-raw-border/40 bg-slate-200 dark:bg-gradient-to-b dark:from-slate-900 dark:to-black sm:mb-10 sm:h-44 sm:rounded-[1.75rem] md:h-52">
