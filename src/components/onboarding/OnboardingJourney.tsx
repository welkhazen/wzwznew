                        ...
                        return (
                          ...
                          >
                            <div className={`relative rounded-full transition-all duration-300 ${
                              ...
                              <AvatarFigure avatarIndex={index} size="sm" selected={isPreviewed} className="sm:hidden" rarity={avatar.rarity} disableRarityGlow />
                              <AvatarFigure avatarIndex={index} size="md" selected={isPreviewed} className="hidden sm:block" rarity={avatar.rarity} disableRarityGlow />
                            </div>
                            <span className={`max-w-full truncate text-center font-display text-[7px] leading-tight tracking-[0.08em] transition-colors sm:text-[8px] ${
