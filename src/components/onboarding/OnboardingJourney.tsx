...
const SPIN_WHEEL_POOL: readonly WheelPoolEntry[] = [
  ...
  { id: "wheel-avatar-5", avatarId: "horned-iron", name: "Viozen", imageSrc: "/avatars/5.webp" },
...
const LANDING_ONBOARDING_AVATARS: readonly AvatarCatalogItem[] = [
  ...
  { id: "preview-horned-iron", level: 13, name: "Viozen", price: "Preview", imageSrc: "/avatars/5.webp", bg: "#1f0a05", figure: "#fb923c", ring: "#fb923c", glow: "#fb923c80", isActive: true, rarity: "common" },
