...
on conflict (id) do update set is_active = true, frame_color = 'green', rank_tier = 3;
...
on conflict (id) do update set is_active = true, frame_color = 'gold', rank_tier = 9;
...
on conflict (id) do update set is_active = true, frame_color = 'rainbow', rank_tier = 11;
