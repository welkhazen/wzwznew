...
values
  ...
  ('spin-35', 107, 'Spin 35', '0', '/avatars/35.png', '#111827', '#cbd5e1', '#cbd5e1', '#cbd5e180', true, 'common'),
  ('spin-20', 108, 'Spin 20', '0', '/avatars/20.png', '#111827', '#cbd5e1', '#cbd5e1', '#cbd5e180', true, 'common'),
  ('spin-26', 109, 'Spin 26', '0', '/avatars/26.png', '#111827', '#cbd5e1', '#cbd5e1', '#cbd5e180', true, 'common'),
